...
:prohibit-ssl-disabled-explicit: Cannot be combined with <<plugins-{type}s-{plugin}-ssl_enabled, `ssl_enabled \=> false`>>.
:prohibit-ssl-verify-none: Cannot be combined with <<plugins-{type}s-{plugin}-ssl_verification_mode, `ssl_verification_mode \=> none`>>.
