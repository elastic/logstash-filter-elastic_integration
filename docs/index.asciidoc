...
For further guidance, we recommend exploring {es} {ref}/ingest.html#pipelines-for-fleet-elastic-agent[Ingest pipelines for fleet] and {integrations-docs}[Elastic {integrations}] resources.
...
For further guidance, we recommend exploring {es} {ref}/ingest.html#handling-pipeline-failures[Handling pipeline failures] documentation.
